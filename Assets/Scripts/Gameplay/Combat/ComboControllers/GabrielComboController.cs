...
public class GabrielComboController : MonoBehaviour
{
    public Animator gabrielAnimator; // Assign Pamela Combo Animator
    ...
    private void StartLightCombo()
    {
        ...
        isAttacking = true;
        comboTimer = 0f;
        gabrielAnimator.SetTrigger("gabrielLightTrigger");
    }
    ...
    private void StartHeavyCombo()
    {
        ...
        isAttacking = true;
        comboTimer = 0f;
        gabrielAnimator.SetTrigger("gabrielHeavyTrigger");
    }
    ...
    private void ResetCombo()
    {
        ...
        isAttacking = false;
        comboTimer = 0f;
        gabrielAnimator.SetTrigger("gabrielResetTrigger");  // reset to idle or neutral state

    }
    public void OnAttackFinished()
    {
        if (comboIndex == 4 && comboType == "light")
        {
            ResetCombo();
        }
