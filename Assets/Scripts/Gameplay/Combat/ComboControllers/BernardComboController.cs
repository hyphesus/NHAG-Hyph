...
public class BernardComboController : MonoBehaviour
{
    public Animator bernardAnimator; // Assign Bernard Combo Animator
    ...
    private void StartLightCombo()
    {
        ...
        isAttacking = true;
        comboTimer = 0f;
        bernardAnimator.SetTrigger("bernardLightTrigger");
    }
    ...
    private void StartHeavyCombo()
    {
        ...
        isAttacking = true;
        comboTimer = 0f;
        bernardAnimator.SetTrigger("bernardHeavyTrigger");
    }
    ...
    private void ResetCombo()
    {
        ...
        isAttacking = false;
        comboTimer = 0f;
        bernardAnimator.SetTrigger("bernardResetTrigger");  // reset to idle or neutral state
