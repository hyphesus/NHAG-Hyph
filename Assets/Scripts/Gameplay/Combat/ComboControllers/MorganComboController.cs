...
public class MorganComboController : MonoBehaviour
{
    public Animator morganAnimator; // Assign Morgan Combo Animator
    ...
    private void StartLightCombo()
    {
        ...
        isAttacking = true;
        comboTimer = 0f;
        morganAnimator.SetTrigger("morganLightTrigger");
    }
    ...
    private void StartHeavyCombo()
    {
        ...
        isAttacking = true;
        comboTimer = 0f;
        morganAnimator.SetTrigger("morganHeavyTrigger");
    }
    ...
    private void ResetCombo()
    {
        ...
        isAttacking = false;
        comboTimer = 0f;
        morganAnimator.SetTrigger("morganResetTrigger");  // reset to idle or neutral state

    }
    public void OnAttackFinished()
    {
        if (comboIndex == 7 && comboType == "light")
        {
            ResetCombo();
        }
